...
let s:red = { 'gui': '#ff5f87', 'cterm': '204', 'cterm16': '1' }
let s:dark_red = { 'gui': '#be5046', 'cterm': '196', 'cterm16': '9' }
let s:green = { 'gui': '#87d787', 'cterm': '114', 'cterm16': '2' }
let s:yellow = { 'gui': '#d7af87', 'cterm': '180', 'cterm16': '3' }
let s:dark_yellow = { 'gui': '#d7875f', 'cterm': '173', 'cterm16': '11' }
let s:blue = { 'gui': '#00afff', 'cterm': '39', 'cterm16': '4' }
let s:purple = { 'gui': '#d75fd7', 'cterm': '170', 'cterm16': '5' }
let s:cyan = { 'gui': '#00afd7', 'cterm': '38', 'cterm16': '6' }
let s:white = { 'gui': '#afafaf', 'cterm': '145', 'cterm16': '15' }
let s:black = { 'gui': '#262626', 'cterm': '235', 'cterm16': '0' }
let s:foreground = { 'gui': '#afafaf', 'cterm': '145', 'cterm16': 'NONE' }
let s:background = { 'gui': '#262626', 'cterm': '235', 'cterm16': 'NONE' }
let s:comment_grey = { 'gui': '#5f5f5f', 'cterm': '59', 'cterm16': '7' }
let s:gutter_fg_grey = { 'gui': '#444444', 'cterm': '238', 'cterm16': '8' }
let s:cursor_grey = { 'gui': '#303030', 'cterm': '236', 'cterm16': '0' }
let s:visual_grey = { 'gui': '#3a3a3a', 'cterm': '237', 'cterm16': '8' }
let s:menu_grey = { 'gui': '#3a3a3a', 'cterm': '237', 'cterm16': '7' }
let s:special_grey = { 'gui': '#3b4048', 'cterm': '238', 'cterm16': '7' }
let s:vertsplit = { 'gui': '#5f5f5f', 'cterm': '59', 'cterm16': '7' }
